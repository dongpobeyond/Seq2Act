...
IN_DIR = os.path.join(
    ...
    "seq2action_entity\\action\\atis\\action0")
OUT_DIR = os.path.join(
    os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))),
    "seq2action_entity\\action\\atis\\seq1")
...
def test(geo_controller, general_controller):
    action_seq = 'add_operation:-:_and add_node:-:$0 add_type_node:-:_flight arg_node:-:$0 add_type_node:-:_daily arg_node:-:$0 add_operation:-:_> add_type_node:-:_arrival_time arg_node:-:$0 add_node:-:$A add_entity_node:-:ent0:_ti arg_node:-:$A end_operation:-:_> ope_arg:-:$A add_operation:-:_< add_type_node:-:_arrival_time arg_node:-:$0 add_node:-:$B add_entity_node:-:ent1:_ti arg_node:-:$B end_operation:-:_< ope_arg:-:$B add_operation:-:_or add_node:-:$C add_entity_node:-:ent0:_ci arg_node:-:$C add_edge:-:_to arg_node:-:$0 arg_node:-:$C add_edge:-:_from arg_node:-:$0 arg_node:-:$C end_operation:-:_or end_operation:-:_and return:-:$0 end_action:-:end'
    print('actions: ' + action_seq)
    entity_lex = {'ent1:_ti': '2100:_ti', 'ent0:_ci': 'denver:_ci', 'ent0:_ti': '2000:_ti'}
...
if __name__ == "__main__":
    atis_grammar_file = os.path.join(
        os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))),
        "seq2action_entity\\ontology\\atis.grammar")
    general_grammar_file = os.path.join(
        os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))),
        "seq2action_entity\\ontology\\atis-general.grammar")
