...
IN_DIR = os.path.join(
    ...
    "seq2action_entity\\action\\atis\\seq0")
...
def test_convertion():
    lf = '( _lambda $0 e ( _and ( _airline $0 ) ( _exists $1 ( _and ( _flight $1 ) ( _or ( _and ( _from $1 milwaukee:_ci ) ( _to $1 st_louis:_ci ) ) ( _and ( _from $1 milwaukee:_ci ) ( _to $1 st_louis:_ci ) ) ( _and ( _to $1 milwaukee:_ci ) ( _to $1 burbank:_ci ) ) ( _and ( _to $1 st_louis:_ci ) ( _from $1 st_louis:_ci ) ) ) ( _= ( _airline:_e $1 ) $0 ) ) ) ) )'
    print(lf)
